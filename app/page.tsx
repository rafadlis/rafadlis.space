            ...
            <CardHeader>
              ...
              <CardDescription>
                <p className="line-clamp-4">
                  I&apos;m Fadli—a software engineer and UX designer with
                  diverse experience (UI/UX Designer, Data Analyst, Data
                  Scientist, and Software Engineer). I solve challenges with
                  innovative code and design, always embracing the latest
                  technologies.
                </p>
              </CardDescription>
            </CardHeader>
          ...
          <Card className="shrink-0 max-md:flex-1">
                ...
                <Popover>
                  ...
                  <PopoverContent align="end" side="bottom">
                    ...
                    >
                      ...
                      <Link
                        href="https://facebook.com/rafadlis"
                        target="_blank"
                      >
                      ...
                      <Link
                        href="https://youtube.com/@rafadlis"
                        target="_blank"
                      >
            ...
            <CardContent className="flex flex-col gap-2">
              <Button
                variant="link"
                asChild
                className="justify-start p-0 h-fit"
              >
                <Link href="https://github.com/rafadlis" target="_blank">
                  <GithubLogoIcon size={24} />
