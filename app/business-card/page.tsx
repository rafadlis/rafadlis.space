export default function BusinessCard() {
  return (
    <article className="flex flex-row flex-wrap gap-6 h-screen w-full items-center justify-center *:rounded-md *:print:rounded-none px-6 py-12">
      <div className="bg-foreground flex h-[51mm] w-[89mm] flex-col items-center justify-center shadow-2xl print:shadow-none print:rounded-none">
        <h1 className="text-5xl font-medium text-background">r.</h1>
      </div>
      <div className="h-[51mm] w-[89mm] shadow-2xl print:shadow-none print:rounded-none py-4 px-6 grid grid-cols-2 grid-rows-2">
        <div>
